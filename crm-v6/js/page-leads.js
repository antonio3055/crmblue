...
function renderSelectedLead() {
  ...
  <div class="sl-scroll">
    ...
    <div class="sl-section">
      ...
      ${l.mtd ? `<div class="field-grid" style="margin-top:8px">
        <div class="field-row"><span class="field-label">MTD Deposits</span><span class="field-val">${fmtMoney(l.mtd.deposits)}</span></div>
        <div class="field-row"><span class="field-label">MTD Balance</span><span class="field-val">${fmtMoney(l.mtd.balance)}</span></div>
      </div>
