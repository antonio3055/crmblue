...
const ICONS = {
  ...
  listUl: '<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M9 6h11"/><path d="M9 12h11"/><path d="M9 18h11"/><circle cx="4.5" cy="6" r="1.2"/><circle cx="4.5" cy="12" r="1.2"/><circle cx="4.5" cy="18" r="1.2"/></svg>',
  listOl: '<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.8"><path d="M10 6h10"/><path d="M10 12h10"/><path d="M10 18h10"/><path d="M4 5.5h1.5V9"/><path d="M3.6 12.2h2.2L3.6 15h2.4"/><path d="M4 16.6h1.8v1.2H4.4v.6h1.4v1.2H4"/></svg>',
  ...
  trendUp: '<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="m4 16.5 5-5 3.5 3.5L20 7.5"/><path d="M15 7.5h5v5"/></svg>'
};
